import {
  ...
  UploadMediaFormItem
} from "./chunk-JMDM6E7M.mjs";
import "./chunk-ZQRKUG6J.mjs";
import "./chunk-7ZCHIREB.mjs";
...
var EditProductMediaForm = ({ product }) => {
  ...
  return /* @__PURE__ */ jsx2(RouteFocusModal.Form, { blockSearch: true, form, children: /* @__PURE__ */ jsxs2(
    KeyboundForm,
    {
      ...
      children: [
        /* @__PURE__ */ jsx2(RouteFocusModal.Header, { children: /* @__PURE__ */ jsx2("div", { className: "flex items-center justify-end gap-x-2", children: /* @__PURE__ */ jsx2(Button, { variant: "secondary", size: "small", asChild: true, children: /* @__PURE__ */ jsx2(Link, { to: { pathname: ".", search: void 0 }, children: t("products.media.galleryLabel") }) }) }) }),
        /* @__PURE__ */ jsx2(RouteFocusModal.Body, { className: "flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxs2("div", { className: "flex size-full flex-col-reverse lg:grid lg:grid-cols-[1fr_560px]", children: [
          ...
          /* @__PURE__ */ jsx2("div", { className: "bg-ui-bg-base overflow-auto border-b px-6 py-4 lg:border-b-0 lg:border-l", children: /* @__PURE__ */ jsx2(UploadMediaFormItem, { form, append }) })
        ] }) }),
