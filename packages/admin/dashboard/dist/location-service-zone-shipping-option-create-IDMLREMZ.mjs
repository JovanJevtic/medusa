...
import {
  DataGrid
} from "./chunk-GLSZJCWM.mjs";
import "./chunk-MWVM4TYO.mjs";
import "./chunk-D5F2TJOW.mjs";
...
import {
  usePricePreferences
} from "./chunk-DKH5JRLO.mjs";
import "./chunk-LPEUYMRK.mjs";
import "./chunk-AI7M5TGP.mjs";
import {
  SwitchBox
} from "./chunk-F3QPCSSK.mjs";
import {
  castNumber
...
function CreateShippingOptionsForm({
  ...
  return /* @__PURE__ */ jsx3(RouteFocusModal.Form, { form, children: /* @__PURE__ */ jsx3(
    ProgressTabs,
    {
      ...
      children: /* @__PURE__ */ jsxs2(KeyboundForm, { className: "flex h-full flex-col", onSubmit: handleSubmit, children: [
        /* @__PURE__ */ jsx3(RouteFocusModal.Header, { children: /* @__PURE__ */ jsxs2(ProgressTabs.List, { className: "border-ui-border-base -my-2 ml-2 min-w-0 flex-1 border-l", children: [
          /* @__PURE__ */ jsx3(
        ...
        /* @__PURE__ */ jsx3(RouteFocusModal.Footer, { children: /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-end gap-x-2", children: [
