...
import {
  useReturnReasons
} from "./chunk-KEKW3HQ7.mjs";
import {
  Thumbnail
} from "./chunk-TOMHEGT5.mjs";
import {
  I18n
} from "./chunk-SHA2UVUF.mjs";
import {
  Close,
  Content,
  Description,
...
import {
  useStore
} from "./chunk-RR5JHWYA.mjs";
import {
  useRegions
} from "./chunk-ODXK5I2N.mjs";
import "./chunk-DKH5JRLO.mjs";
import {
  productLoader
} from "./chunk-C2YW3X33.mjs";
import {
  getCountryByIso2
...
import {
  languages
} from "./chunk-WRFZQUR6.mjs";
import "./chunk-AI7M5TGP.mjs";
import {
  useSalesChannels
} from "./chunk-5JDGO6KD.mjs";
import "./chunk-R6QFVP7W.mjs";
import {
        ...
        children: [
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-7JZVC7GS.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-FMKT2FO2.mjs")
                  },
                  {
                    path: "import",
                    lazy: () => import("./product-import-Q3CS4MCI.mjs")
                  },
                  {
                    path: "export",
                    lazy: () => import("./product-export-OMBYJWZQ.mjs")
                  }
                ]
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-4ZHQLZM2.mjs"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-NTITYGVI.mjs")
                      },
                      {
                        path: "edit-variant",
                        lazy: () => import("./product-variant-edit-HUJPENXO.mjs")
                      },
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-R75PS56N.mjs")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-UC7HAB5F.mjs")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-UQDQ4T4B.mjs")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-AE62HUT2.mjs")
                      },
                      {
                        path: "prices",
                        lazy: () => import("./product-prices-KSUZADMI.mjs")
                      },
                      {
                        path: "options/create",
                        lazy: () => import("./product-create-option-7SOH63PV.mjs")
                      },
                      {
                        path: "options/:option_id/edit",
                        lazy: () => import("./product-edit-option-CHCPPNFQ.mjs")
                      },
                      {
                        path: "variants/create",
                        lazy: () => import("./product-create-variant-V2DXVQUL.mjs")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-metadata-XBCJB32D.mjs")
                      }
                    ]
                  },
                  {
                    path: "variants/:variant_id",
                    lazy: () => import("./product-variant-detail-3COEH2FI.mjs"),
                    handle: {
                    ...
                    children: [
                      ...
                      {
                        path: "manage-items",
                        lazy: () => import("./product-variant-manage-inventory-items-LQRD4GMJ.mjs")
                      }
                    ]
                  }
                ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-P3EHN3PW.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./category-create-ND7TXZXV.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-TCP7BAVZ.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./category-detail-UMHN6QW3.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./category-edit-ME4YG4MP.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./category-products-2JGDE42H.mjs")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-TCP7BAVZ.mjs")
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./categories-metadata-4OPXZ6JK.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-VYRMOFND.mjs")
              },
              {
                path: ":id",
                lazy: () => import("./order-detail-ZUSNWT6G.mjs"),
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-2DWNVNIJ.mjs")
                  },
                  {
                    path: "returns/:return_id/receive",
                    lazy: () => import("./order-receive-return-IWNDYNRW.mjs")
                  },
                  {
                    path: "allocate-items",
                    lazy: () => import("./order-allocate-items-2XMMLGMP.mjs")
                  },
                  {
                    path: ":f_id/create-shipment",
                    lazy: () => import("./order-create-shipment-66XTIXYR.mjs")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-FQACORB6.mjs")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-LV3P6OY6.mjs")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-ASEXDIBH.mjs")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-MQNDSWNK.mjs")
                  },
                  {
                    path: "refund",
                    lazy: () => import("./order-create-refund-ZTDPSQ4A.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-NZZJN4B6.mjs")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-ZQCVZGCF.mjs")
              },
              {
                path: ":id",
                lazy: () => import("./promotion-detail-FKFVB5AM.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./promotion-edit-details-LPWMUGLY.mjs")
                  },
                  {
                    path: "add-to-campaign",
                    lazy: () => import("./promotion-add-campaign-JKXADG6T.mjs")
                  },
                  {
                    path: ":ruleType/edit",
                    lazy: () => import("./edit-rules-PUWJZXXY.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-7S3IT455.mjs"),
                children: []
              },
              {
                path: "create",
                lazy: () => import("./campaign-create-A6H27PKA.mjs")
              },
              {
                path: ":id",
                lazy: () => import("./campaign-detail-SK36MFP4.mjs"),
                handle: { crumb: (data) => data.campaign.name },
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./campaign-edit-GMIREKVE.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./campaign-configuration-Z45ANERG.mjs")
                  },
                  {
                    path: "edit-budget",
                    lazy: () => import("./campaign-budget-edit-56BX34QV.mjs")
                  },
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-OQPZBRKW.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-D33HVBUV.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./collection-create-TGPFWL54.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./collection-detail-MSV67M5Q.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./collection-edit-YE7GXOIN.mjs")
                  },
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-5G6B76XQ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-JOZVA3Y7.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-XUC7NJPY.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./price-list-detail-MQBSS2B3.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./price-list-edit-ONEYVC2K.mjs")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-H3JW2RQ5.mjs")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-I5FS4A3A.mjs")
                  },
                  {
                    path: "products/edit",
                    lazy: () => import("./price-list-prices-edit-IHJLSP7D.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-KXE2TVBM.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-create-ED7VZYQ7.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./customer-detail-7HBBI27U.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-edit-RQUIB4HG.mjs")
                  },
                  {
                    path: "add-customer-groups",
                    lazy: () => import("./customers-add-customer-group-DDBZLBFO.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-metadata-3UNV3TNS.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-4K3JGBFR.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-group-create-4HKYJHLM.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./customer-group-detail-L55D7POK.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-group-edit-XODFQYAN.mjs")
                  },
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-E3RR5DIY.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-group-metadata-GDCAQUYZ.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-DJUGHYLK.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./reservation-create-4INK4RET.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./reservation-detail-7EESJX6T.mjs"),
                handle: {
                  crumb: ({ reservation }) => {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-reservation-VZWJXI4M.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./reservation-metadata-N2KMP5KX.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-M772RMXN.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./inventory-create-EEXLSKUS.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./inventory-detail-L3VBDUHQ.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-inventory-item-7MMQXCQD.mjs")
                  },
                  {
                    path: "attributes",
                    lazy: () => import("./edit-inventory-item-attributes-IYN627HZ.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./inventory-metadata-D4T45R7U.mjs")
                  },
                  {
                    path: "locations",
                    lazy: () => import("./manage-locations-7NBZ3DYZ.mjs")
                  },
                  {
                    path: "locations/:location_id",
                    lazy: () => import("./adjust-inventory-TJJ7XPLO.mjs")
                  }
                ]
              }
            ]
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            path: "profile",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-L6X3ZHPT.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-SIOUUTZW.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-FLUJ6IA6.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-EHH2HCOQ.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./region-detail-5DENN6PA.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./region-edit-4SLUKHUB.mjs")
                  },
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-FMPMMJFF.mjs")
                  }
                ]
              }
            ]
          },
          {
            path: "store",
            errorElement: /* @__PURE__ */ jsx17(ErrorBoundary, {}),
            lazy: () => import("./store-detail-E6IJYN26.mjs"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./store-edit-NUIRANWR.mjs")
              },
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-GDQXF7X4.mjs")
              },
              {
                path: "metadata/edit",
                lazy: () => import("./store-metadata-EAYSCLBY.mjs")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-HKEHYLPM.mjs"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-TVJ3VQDX.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./user-detail-IMOOJ3AY.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./user-edit-LHEBYTQQ.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./user-metadata-AJHHTYFS.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-RN5ZI455.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./sales-channel-create-YFOAU3SS.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./sales-channel-detail-XA6RAK52.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./sales-channel-edit-2LDM3SAD.mjs")
                  },
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-DOYS3ELU.mjs")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./sales-channel-metadata-VDZJYZ7S.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-LBTUZ7M7.mjs")
              },
              {
                path: "create",
                lazy: () => import("./location-create-KOGEC4SF.mjs")
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-6EPOCRNP.mjs"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./shipping-profile-create-HOD2RW65.mjs")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: () => import("./shipping-profile-detail-BFPQKLNJ.mjs")
                  }
                ]
              },
              {
                path: ":location_id",
                lazy: () => import("./location-detail-K3GRUUNU.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./location-edit-YLP7CVH2.mjs")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-RIQC435T.mjs")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-UJNQLD2F.mjs")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-JWUSJUFK.mjs")
                      },
                      {
                        ...
                        children: [
                          {
                            path: "edit",
                            lazy: () => import("./location-service-zone-edit-JARWOZJ3.mjs")
                          },
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-3FCYTTRZ.mjs")
                          },
                          {
                            ...
                            children: [
                              {
                                path: "create",
                                lazy: () => import("./location-service-zone-shipping-option-create-IDMLREMZ.mjs")
                              },
                              {
                                path: ":so_id",
                                children: [
                                  {
                                    path: "edit",
                                    lazy: () => import("./location-service-zone-shipping-option-edit-DOGSA5H7.mjs")
                                  },
                                  {
                                    path: "pricing",
                                    lazy: () => import("./location-service-zone-shipping-option-pricing-UP4RZNBE.mjs")
                                  }
                                ]
                              }
                            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-5WRLXXD5.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-tag-create-X4SZU5C4.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./product-tag-detail-UEIRJC2F.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-tag-edit-SYW4UR42.mjs")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-NJ6IAOLA.mjs")
              },
              {
                path: ":id",
                lazy: () => import("./workflow-execution-detail-MAW4PL2K.mjs"),
                handle: {
                  crumb: (data) => {
                    if (!data) {
                      return "";
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-WYNXBGQQ.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-type-create-IDXNAUEQ.mjs")
                  }
                ]
              },
              {
                path: ":id",
                lazy: () => import("./product-type-detail-62B5P4IT.mjs"),
                handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-type-edit-YPRVZADZ.mjs")
                  }
                ]
              }
            ]
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-CRM6XKHZ.mjs"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./api-key-management-create-LLZI5UN4.mjs")
                      }
                    ]
                  }
                ]
              ...
              {
                path: ":id",
                lazy: () => import("./api-key-management-detail-BPEVTV44.mjs"),
                handle: {
                  crumb: (data) => {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./api-key-management-edit-VVTVMUF7.mjs")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-Y3A7L7LZ.mjs")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-Z3FJ4UTB.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./tax-region-create-G7MMZVX7.mjs")
                  }
                ]
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./tax-region-detail-IVIP5U6I.mjs"),
                    children: [
                      {
                        path: "provinces/create",
                        lazy: () => import("./tax-region-province-create-JMZKIGXI.mjs")
                      },
                      {
                        path: "overrides/create",
                        lazy: () => import("./tax-region-tax-override-create-RHM5FQ7B.mjs")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-P2EFVNYQ.mjs")
                      },
                      {
                        path: "tax-rates/create",
                        lazy: () => import("./tax-region-tax-rate-create-H7NDMY5B.mjs")
                      },
                      {
                        path: "tax-rates/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-rate-edit-G5HHHAX5.mjs")
                      }
                    ]
                  },
                  {
                    path: "provinces/:province_id",
                    lazy: () => import("./tax-region-province-detail-J7FHR2ZH.mjs"),
                    handle: {
                      crumb: (data) => {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-TQB3YOFU.mjs"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./return-reason-create-JEVFP5ES.mjs")
                  },
                  {
                    path: ":id",
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./return-reason-edit-PYKQ6BLX.mjs")
                      }
                    ]
                  }
                ]
    ...
    children: [
      {
        ...
        children: [
          ...
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-KWRVI66I.mjs")
          },
          {
            path: "/invite",
            lazy: () => import("./invite-MPIBLVZ7.mjs")
          },
          {
            path: "*",
