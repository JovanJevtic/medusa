...
var ProductAttributeSection = ({
  ...
  return /* @__PURE__ */ jsxs(Container, { className: "divide-y p-0", children: [
    ...
    getDisplays("product", "attributes").map((Component2, i) => {
      return /* @__PURE__ */ jsx(Component2, { data: product }, i);
    })
  ] });
};
...
var ProductGeneralSection = ({
  ...
  return /* @__PURE__ */ jsxs2(Container2, { className: "divide-y p-0", children: [
    ...
    displays.map((Component2, index) => {
      return /* @__PURE__ */ jsx2(Component2, { data: product }, index);
    })
  ] });
};
...
var ProductOrganizationSection = ({
  ...
  return /* @__PURE__ */ jsxs5(Container5, { className: "divide-y p-0", children: [
    ...
    getDisplays("product", "organize").map((Component2, i) => {
      return /* @__PURE__ */ jsx5(Component2, { data: product }, i);
    })
  ] });
};
...
import { Container as Container6, Heading as Heading6, Text as Text2, Tooltip as Tooltip2 } from "@medusajs/ui";
  ...
  return /* @__PURE__ */ jsxs6(Container6, { className: "flex flex-col gap-y-4 px-6 py-4", children: [
    ...
    /* @__PURE__ */ jsxs6("div", { className: "grid grid-cols-[28px_1fr] items-center gap-x-3", children: [
      ...
      availableInSalesChannels.length > 0 ? /* @__PURE__ */ jsxs6("div", { className: "flex items-center gap-x-1", children: [
        /* @__PURE__ */ jsx6(Text2, { size: "small", leading: "compact", children: firstChannels.map((sc) => sc.name).join(", ") }),
      ...
      ] }) : /* @__PURE__ */ jsx6(Text2, { size: "small", leading: "compact", className: "text-ui-fg-subtle", children: t("products.noSalesChannels") })
    ] }),
    /* @__PURE__ */ jsx6("div", { children: /* @__PURE__ */ jsx6(Text2, { className: "text-ui-fg-subtle", size: "small", leading: "compact", children: /* @__PURE__ */ jsx6(
      Trans,
      {
