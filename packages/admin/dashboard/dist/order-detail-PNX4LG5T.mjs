...
import {
  ...
  useClaims
} from "./chunk-N6TUURP2.mjs";
import {
  useCancelExchange,
  useCancelExchangeRequest,
  useExchanges
} from "./chunk-5AAZGSHR.mjs";
import {
...
import { Button as Button5, IconButton, Text as Text5, Tooltip, clx, usePrompt } from "@medusajs/ui";
...
var OrderTimeline = ({ order }) => {
  ...
  if (items.length <= 3) {
    return /* @__PURE__ */ jsx6("div", { className: "flex flex-col gap-y-0.5", children: items.map((item, index) => {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "flex flex-col gap-y-0.5", children: [
    ...
    /* @__PURE__ */ jsx6(OrderActivityCollapsible, { activities: collapsibleItems }),
    /* @__PURE__ */ jsx6(
      OrderActivityItem,
      {
  ...
  return useMemo2(() => {
    ...
    for (const payment of payments) {
      ...
      items.push({
        ...
        children: /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: getStylizedAmount(amount, payment.currency_code) })
      });
      ...
      for (const refund of payment.refunds || []) {
        items.push({
          ...
          children: /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: getStylizedAmount(
            refund.amount,
    ...
    for (const fulfillment of order.fulfillments || []) {
      items.push({
        ...
        children: /* @__PURE__ */ jsx6(FulfillmentCreatedBody, { fulfillment })
      });
      ...
      if (fulfillment.shipped_at) {
        items.push({
          ...
          children: /* @__PURE__ */ jsx6(FulfillmentCreatedBody, { fulfillment, isShipment: true })
        });
      }
    ...
    for (const ret of returns) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsx6(ReturnBody, { orderReturn: ret, isCreated: !ret.canceled_at })
      });
      if (ret.canceled_at) {
        items.push({
      ...
      if (ret.status === "received" || ret.status === "partially_received") {
        items.push({
          ...
          itemsToReturn: ret?.items,
          itemsMap,
          children: /* @__PURE__ */ jsx6(ReturnBody, { orderReturn: ret, isReceived: true })
        });
      }
    }
    for (const claim of claims) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsx6(ClaimBody, { claim, claimReturn })
      });
    }
    for (const exchange of exchanges) {
      ...
      items.push({
        ...
        itemsMap,
        children: /* @__PURE__ */ jsx6(ExchangeBody, { exchange, exchangeReturn })
      });
    }
    for (const edit of orderChanges.filter((oc) => oc.change_type === "edit")) {
      ...
      items.push({
        ...
        children: isConfirmed ? /* @__PURE__ */ jsx6(OrderEditBody, { edit, itemsMap }) : null
      });
    }
    ...
    const createdAt = {
      ...
      children: /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: getStylizedAmount(order.total, order.currency_code) })
    };
...
var OrderActivityItem = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "grid grid-cols-[20px_1fr] items-start gap-2", children: [
    /* @__PURE__ */ jsxs6("div", { className: "flex size-full flex-col items-center gap-y-0.5", children: [
      /* @__PURE__ */ jsx6("div", { className: "flex size-5 items-center justify-center", children: /* @__PURE__ */ jsx6("div", { className: "bg-ui-bg-base shadow-borders-base flex size-2.5 items-center justify-center rounded-full", children: /* @__PURE__ */ jsx6("div", { className: "bg-ui-tag-neutral-icon size-1.5 rounded-full" }) }) }),
      !isFirst && /* @__PURE__ */ jsx6("div", { className: "bg-ui-border-base w-px flex-1" })
    ] }),
    /* @__PURE__ */ jsxs6(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs6("div", { className: "flex items-center justify-between", children: [
            itemsToSend?.length || itemsToReturn?.length ? /* @__PURE__ */ jsx6(
              ...
              title
            ) : /* @__PURE__ */ jsx6(Text5, { size: "small", leading: "compact", weight: "plus", children: title }),
            timestamp && /* @__PURE__ */ jsx6(
              Tooltip,
              {
...
var OrderActivityCollapsible = ({
  ...
  return /* @__PURE__ */ jsxs6(Collapsible.Root, { open, onOpenChange: setOpen, children: [
    !open && /* @__PURE__ */ jsxs6("div", { className: "grid grid-cols-[20px_1fr] items-start gap-2", children: [
      /* @__PURE__ */ jsx6("div", { className: "flex size-full flex-col items-center", children: /* @__PURE__ */ jsx6("div", { className: "border-ui-border-strong w-px flex-1 bg-[linear-gradient(var(--border-strong)_33%,rgba(255,255,255,0)_0%)] bg-[length:1px_3px] bg-right bg-repeat-y" }) }),
      /* @__PURE__ */ jsx6("div", { className: "pb-4", children: /* @__PURE__ */ jsx6(Collapsible.Trigger, { className: "text-left", children: /* @__PURE__ */ jsx6(
        Text5,
        {
          size: "small",
          leading: "compact",
    ...
    /* @__PURE__ */ jsx6(Collapsible.Content, { children: /* @__PURE__ */ jsx6("div", { className: "flex flex-col gap-y-0.5", children: activities.map((item, index) => {
      return /* @__PURE__ */ jsx6(
        OrderActivityItem,
        {
          title: item.title,
...
var FulfillmentCreatedBody = ({
  ...
  return /* @__PURE__ */ jsx6("div", { children: /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.fulfillment.items", {
    count: numberOfItems
  }) }) });
};
var ReturnBody = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "flex items-start gap-1", children: [
    /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.return.items", {
      count: numberOfItems
    }) }),
    isCreated && /* @__PURE__ */ jsxs6(Fragment, { children: [
      /* @__PURE__ */ jsx6("div", { className: "mt-[2px] flex items-center leading-none", children: "\u22C5" }),
      /* @__PURE__ */ jsx6(
        Button5,
        {
          onClick: onCancel,
...
var ClaimBody = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { children: [
    outboundItems > 0 && /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.claim.itemsInbound", {
      count: outboundItems
    }) }),
    inboundItems > 0 && /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.claim.itemsOutbound", {
      count: inboundItems
    }) }),
    !isCanceled && /* @__PURE__ */ jsx6(
      Button5,
      {
        onClick: onCancel,
        className: "text-ui-fg-subtle h-auto px-0 leading-none hover:bg-transparent",
...
var ExchangeBody = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { children: [
    outboundItems > 0 && /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.exchange.itemsInbound", {
      count: outboundItems
    }) }),
    inboundItems > 0 && /* @__PURE__ */ jsx6(Text5, { size: "small", className: "text-ui-fg-subtle", children: t("orders.activity.events.exchange.itemsOutbound", {
      count: inboundItems
    }) }),
    !isCanceled && /* @__PURE__ */ jsx6(
      Button5,
...
var OrderEditBody = ({
  ...
  return /* @__PURE__ */ jsxs6("div", { children: [
    itemsAdded > 0 && /* @__PURE__ */ jsxs6(Text5, { size: "small", className: "text-ui-fg-subtle", children: [
      t("labels.added"),
      ": ",
      itemsAdded
    ] }),
    itemsRemoved > 0 && /* @__PURE__ */ jsxs6(Text5, { size: "small", className: "text-ui-fg-subtle", children: [
      t("labels.removed"),
      ": ",
      itemsRemoved
    ] })
...
var OrderActivitySection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs7(Container5, { className: "flex flex-col gap-y-8 px-6 py-4", children: [
    /* @__PURE__ */ jsx7("div", { className: "flex flex-col gap-y-4", children: /* @__PURE__ */ jsx7("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsx7(Heading5, { level: "h2", children: t("orders.activity.header") }) }) }),
    /* @__PURE__ */ jsx7(OrderTimeline, { order })
  ] });
};
...
import { Avatar, Copy as Copy2, Text as Text6 } from "@medusajs/ui";
...
var ID = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
    /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", weight: "plus", children: t("fields.id") }),
    /* @__PURE__ */ jsx8(
      Link2,
      {
        to: `/customers/${id}`,
        className: "focus:shadow-borders-focus rounded-[4px] outline-none transition-shadow",
        children: /* @__PURE__ */ jsxs8("div", { className: "flex items-center gap-x-2 overflow-hidden", children: [
          /* @__PURE__ */ jsx8(Avatar, { size: "2xsmall", fallback }),
          /* @__PURE__ */ jsx8(
            Text6,
            {
              size: "small",
...
var Company = ({ data }) => {
  ...
  return /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
    /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", weight: "plus", children: t("fields.company") }),
    /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", className: "truncate", children: company })
  ] });
};
var Contact = ({ data }) => {
  const { t } = useTranslation8();
  ...
  const email = data.email || "";
  return /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
    /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", weight: "plus", children: t("orders.customer.contactLabel") }),
    /* @__PURE__ */ jsxs8("div", { className: "flex flex-col gap-y-2", children: [
      /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-[1fr_20px] items-start gap-x-2", children: [
        /* @__PURE__ */ jsx8(
          Text6,
          {
            size: "small",
        ...
        /* @__PURE__ */ jsx8("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx8(Copy2, { content: email, className: "text-ui-fg-muted" }) })
      ] }),
      phone && /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-[1fr_20px] items-start gap-x-2", children: [
        /* @__PURE__ */ jsx8(
          Text6,
          {
            size: "small",
...
var AddressPrint = ({
  ...
  const { t } = useTranslation8();
  return /* @__PURE__ */ jsxs8("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
    /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", weight: "plus", children: type === "shipping" ? t("addresses.shippingAddress.label") : t("addresses.billingAddress.label") }),
    address ? /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-[1fr_20px] items-start gap-x-2", children: [
      /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", children: getFormattedAddress({ address }).map((line, i) => {
        return /* @__PURE__ */ jsxs8("span", { className: "break-words", children: [
          line,
          /* @__PURE__ */ jsx8("br", {})
        ] }, i);
      }) }),
    ...
    ] }) : /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", children: "-" })
  ] });
};
var Addresses = ({ data }) => {
  const { t } = useTranslation8();
  return /* @__PURE__ */ jsxs8("div", { className: "divide-y", children: [
    /* @__PURE__ */ jsx8(AddressPrint, { address: data.shipping_address, type: "shipping" }),
    !isSameAddress(data.shipping_address, data.billing_address) ? /* @__PURE__ */ jsx8(AddressPrint, { address: data.billing_address, type: "billing" }) : /* @__PURE__ */ jsxs8("div", { className: "grid grid-cols-2 items-center px-6 py-4", children: [
      /* @__PURE__ */ jsx8(
        Text6,
        {
          size: "small",
      ...
      /* @__PURE__ */ jsx8(Text6, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: t("addresses.billingAddress.sameAsShipping") })
    ] })
  ] });
};
...
var OrderCustomerSection = ({ order }) => {
  return /* @__PURE__ */ jsxs9(Container6, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsx9(Header, {}),
    /* @__PURE__ */ jsx9(CustomerInfo.ID, { data: order }),
    /* @__PURE__ */ jsx9(CustomerInfo.Contact, { data: order }),
    /* @__PURE__ */ jsx9(CustomerInfo.Company, { data: order }),
    /* @__PURE__ */ jsx9(CustomerInfo.Addresses, { data: order })
  ] });
};
var Header = () => {
  const { t } = useTranslation9();
  return /* @__PURE__ */ jsxs9("div", { className: "flex items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsx9(Heading6, { level: "h2", children: t("fields.customer") }),
    /* @__PURE__ */ jsx9(
      ActionMenu,
      {
        groups: [
            ...
            actions: [
              {
                ...
                to: "shipping-address",
                icon: /* @__PURE__ */ jsx9(FlyingBox, {})
              },
              {
                label: t("addresses.billingAddress.editLabel"),
                to: "billing-address",
                icon: /* @__PURE__ */ jsx9(CurrencyDollar, {})
              }
            ]
          },
          {
...
var OrderFulfillmentSection = ({
  ...
  return /* @__PURE__ */ jsxs10("div", { className: "flex flex-col gap-y-3", children: [
    /* @__PURE__ */ jsx10(UnfulfilledItemBreakdown, { order }),
    fulfillments.map((f, index) => /* @__PURE__ */ jsx10(Fulfillment, { index, fulfillment: f, order }, f.id))
  ] });
};
var UnfulfilledItem = ({
  item,
  ...
  return /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs10("div", { className: "flex items-start gap-x-4", children: [
          /* @__PURE__ */ jsx10(Thumbnail, { src: item.thumbnail }),
          /* @__PURE__ */ jsxs10("div", { children: [
            ...
            item.variant.sku && /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-x-1", children: [
              /* @__PURE__ */ jsx10(Text7, { size: "small", children: item.variant.sku }),
              /* @__PURE__ */ jsx10(Copy3, { content: item.variant.sku, className: "text-ui-fg-muted" })
            ] }),
            /* @__PURE__ */ jsx10(Text7, { size: "small", children: item.variant.options.map((o) => o.value).join(" \xB7 ") })
          ] })
        ] }),
        /* @__PURE__ */ jsxs10("div", { className: "grid grid-cols-3 items-center gap-x-4", children: [
          /* @__PURE__ */ jsx10("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsx10(Text7, { size: "small", children: getLocaleAmount(item.unit_price, currencyCode) }) }),
          /* @__PURE__ */ jsx10("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsxs10(Text7, { children: [
            /* @__PURE__ */ jsx10("span", { className: "tabular-nums", children: item.quantity - item.detail.fulfilled_quantity }),
            "x"
          ] }) }),
          /* @__PURE__ */ jsx10("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsx10(Text7, { size: "small", children: getLocaleAmount(item.subtotal || 0, currencyCode) }) })
        ] })
      ]
    },
    item.id
...
var UnfulfilledItemBreakdown = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs10(Fragment2, { children: [
    !!unfulfilledItemsWithShipping.length && /* @__PURE__ */ jsx10(
    ...
    !!unfulfilledItemsWithoutShipping.length && /* @__PURE__ */ jsx10(
      UnfulfilledItemDisplay,
      {
        order,
...
var UnfulfilledItemDisplay = ({
  ...
  return /* @__PURE__ */ jsxs10(Container7, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Heading7, { level: "h2", children: t("orders.fulfillment.unfulfilledItems") }),
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-x-4", children: [
        requiresShipping && /* @__PURE__ */ jsx10(StatusBadge, { color: "red", className: "text-nowrap", children: t("orders.fulfillment.requiresShipping") }),
        /* @__PURE__ */ jsx10(StatusBadge, { color: "red", className: "text-nowrap", children: t("orders.fulfillment.awaitingFulfillmentBadge") }),
        /* @__PURE__ */ jsx10(
          ActionMenu,
          {
            groups: [
    ...
    /* @__PURE__ */ jsx10("div", { children: unfulfilledItems.map((item) => /* @__PURE__ */ jsx10(
      UnfulfilledItem,
      {
        item,
...
var Fulfillment = ({
  ...
  return /* @__PURE__ */ jsxs10(Container7, { className: "divide-y p-0", children: [
    /* @__PURE__ */ jsxs10("div", { className: "flex items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Heading7, { level: "h2", children: t("orders.fulfillment.number", {
        number: index + 1
      }) }),
      /* @__PURE__ */ jsxs10("div", { className: "flex items-center gap-x-4", children: [
        /* @__PURE__ */ jsx10(
          Tooltip2,
          {
            ...
            children: /* @__PURE__ */ jsx10(StatusBadge, { color: statusColor, className: "text-nowrap", children: statusText })
          }
        ),
        /* @__PURE__ */ jsx10(
          ActionMenu,
    ...
    /* @__PURE__ */ jsxs10("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", weight: "plus", children: t("orders.fulfillment.itemsLabel") }),
      /* @__PURE__ */ jsx10("ul", { children: fulfillment.items.map((f_item) => /* @__PURE__ */ jsx10("li", { children: /* @__PURE__ */ jsxs10(Text7, { size: "small", leading: "compact", children: [
        f_item.quantity,
        "x ",
        f_item.title
      ] }) }, f_item.line_item_id)) })
    ] }),
    showLocation && /* @__PURE__ */ jsxs10("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", weight: "plus", children: t("orders.fulfillment.shippingFromLabel") }),
      stock_location ? /* @__PURE__ */ jsx10(
        Link3,
        {
          to: `/settings/locations/${stock_location.id}`,
          className: "text-ui-fg-interactive hover:text-ui-fg-interactive-hover transition-fg",
          children: /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", children: stock_location.name })
        }
      ) : /* @__PURE__ */ jsx10(Skeleton, { className: "w-16" })
    ] }),
    /* @__PURE__ */ jsxs10("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-center px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", weight: "plus", children: t("fields.provider") }),
      /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", children: formatProvider(fulfillment.provider_id) })
    ] }),
    /* @__PURE__ */ jsxs10("div", { className: "text-ui-fg-subtle grid grid-cols-2 items-start px-6 py-4", children: [
      /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", weight: "plus", children: t("orders.fulfillment.trackingLabel") }),
      /* @__PURE__ */ jsx10("div", { children: fulfillment.labels && fulfillment.labels.length > 0 ? /* @__PURE__ */ jsx10("ul", { children: fulfillment.labels.map((tlink) => {
        ...
        if (hasUrl) {
          return /* @__PURE__ */ jsx10("li", { children: /* @__PURE__ */ jsx10(
            "a",
            {
              ...
              className: "text-ui-fg-interactive hover:text-ui-fg-interactive-hover transition-fg",
              children: /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", children: tlink.tracking_number })
            }
          ) }, tlink.tracking_number);
        }
        return /* @__PURE__ */ jsx10("li", { children: /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", children: tlink.tracking_number }) }, tlink.tracking_number);
      }) }) : /* @__PURE__ */ jsx10(Text7, { size: "small", leading: "compact", children: "-" }) })
    ] }),
    (showShippingButton || showDeliveryButton) && /* @__PURE__ */ jsxs10("div", { className: "bg-ui-bg-subtle flex items-center justify-end rounded-b-xl px-4 py-4 gap-x-2", children: [
      showDeliveryButton && /* @__PURE__ */ jsx10(Button6, { onClick: handleMarkAsDelivered, variant: "secondary", children: t("orders.fulfillment.markAsDelivered") }),
      showShippingButton && /* @__PURE__ */ jsx10(
        Button6,
        {
...
var OrderGeneralSection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs11(Container8, { className: "flex items-center justify-between px-6 py-4", children: [
    /* @__PURE__ */ jsxs11("div", { children: [
      /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-x-1", children: [
        /* @__PURE__ */ jsxs11(Heading8, { children: [
          "#",
          order.display_id
        ] }),
        /* @__PURE__ */ jsx11(Copy4, { content: `#${order.display_id}`, className: "text-ui-fg-muted" })
      ] }),
      /* @__PURE__ */ jsx11(Text8, { size: "small", className: "text-ui-fg-subtle", children: t("orders.onDateFromSalesChannel", {
        date: format2(new Date(order.created_at), "dd MMM, yyyy, HH:mm:ss"),
        salesChannel: order.sales_channel?.name
      }) })
    ] }),
    /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-x-4", children: [
      /* @__PURE__ */ jsxs11("div", { className: "flex items-center gap-x-1.5", children: [
        /* @__PURE__ */ jsx11(PaymentBadge, { order }),
        /* @__PURE__ */ jsx11(FulfillmentBadge, { order })
      ] }),
      /* @__PURE__ */ jsx11(
        ActionMenu,
        {
...
var FulfillmentBadge = ({ order }) => {
  ...
  return /* @__PURE__ */ jsx11(StatusBadge2, { color, className: "text-nowrap", children: label });
};
...
var ButtonMenu = ({
  ...
  return /* @__PURE__ */ jsxs12(DropdownMenu, { children: [
    /* @__PURE__ */ jsx12(DropdownMenu.Trigger, { asChild: true, children }),
    /* @__PURE__ */ jsx12(DropdownMenu.Content, { children: groups.map((group, index) => {
      if (!group.actions.length) {
        return null;
      }
      const isLast = index === groups.length - 1;
      return /* @__PURE__ */ jsxs12(DropdownMenu.Group, { children: [
        group.actions.map((action, index2) => {
          ...
          return /* @__PURE__ */ jsx12("div", { children: /* @__PURE__ */ jsx12(
            DropdownMenu.Item,
            {
              className: clx2(
                "[&_svg]:text-ui-fg-subtle flex items-center gap-x-2",
              ...
              asChild: true,
              disabled: action.disabled,
              children: /* @__PURE__ */ jsxs12(Link4, { to: action.to, onClick: (e) => e.stopPropagation(), children: [
                action.icon,
                /* @__PURE__ */ jsx12("span", { children: action.label })
              ] })
            }
        ...
        !isLast && /* @__PURE__ */ jsx12(DropdownMenu.Separator, {})
      ] }, index);
    }) })
  ] });
};
...
var CopyPaymentLink = React.forwardRef(
  ({ paymentCollection, order }, ref) => {
    ...
    return /* @__PURE__ */ jsx13(Tooltip3, { content: text, open: done || open, onOpenChange: setOpen, children: /* @__PURE__ */ jsxs13(
      Button7,
      {
        ref,
        variant: "secondary",
...
import { Badge, Popover as Popover2, Text as Text9 } from "@medusajs/ui";
...
function ReturnInfoPopover({ orderReturn }) {
  ...
  return /* @__PURE__ */ jsxs14(Popover2, { open, children: [
    /* @__PURE__ */ jsx14(
      Popover2.Trigger,
      {
        onMouseEnter: handleMouseEnter,
    ...
    /* @__PURE__ */ jsx14(
      Popover2.Content,
      {
        ...
        children: /* @__PURE__ */ jsxs14("div", { className: "", children: [
          /* @__PURE__ */ jsxs14(Badge, { size: "2xsmall", className: "mb-2", rounded: "full", children: [
            returnType,
            ": #",
            returnTypeId.slice(-7)
          ] }),
          /* @__PURE__ */ jsxs14(Text9, { size: "xsmall", children: [
...
function ShippingInfoPopover({ shippingMethod }) {
  ...
  return /* @__PURE__ */ jsx15(
    Tooltip4,
    {
      content: /* @__PURE__ */ jsxs15(Badge2, { size: "2xsmall", rounded: "full", children: [
        rmaType,
        ": #",
        rmaId.slice(-7)
      ] }),
...
var OrderSummarySection = ({ order }) => {
  ...
  return /* @__PURE__ */ jsxs16(Container9, { className: "divide-y divide-dashed p-0", children: [
    ...
    (showAllocateButton || showReturns || showPayment || showRefund) && /* @__PURE__ */ jsxs16("div", { className: "bg-ui-bg-subtle flex items-center justify-end gap-x-2 rounded-b-xl px-4 py-4", children: [
...
var Header2 = ({
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "flex items-center justify-between px-6 py-4", children: [
  ...
  return /* @__PURE__ */ jsxs16(Fragment3, { children: [
    /* @__PURE__ */ jsxs16(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs16("div", { className: "flex items-start gap-x-4", children: [
            ...
            /* @__PURE__ */ jsxs16("div", { children: [
              ...
              item.variant_sku && /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-x-1", children: [
                /* @__PURE__ */ jsx16(Text10, { size: "small", children: item.variant_sku }),
                /* @__PURE__ */ jsx16(Copy5, { content: item.variant_sku, className: "text-ui-fg-muted" })
              ] }),
              /* @__PURE__ */ jsx16(Text10, { size: "small", children: item.variant?.options?.map((o) => o.value).join(" \xB7 ") })
            ] })
          ] }),
          /* @__PURE__ */ jsxs16("div", { className: "grid grid-cols-3 items-center gap-x-4", children: [
            /* @__PURE__ */ jsx16("div", { className: "flex items-center justify-end gap-x-4", children: /* @__PURE__ */ jsx16(Text10, { size: "small", children: getLocaleAmount(item.unit_price, currencyCode) }) }),
            /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-x-2", children: [
              /* @__PURE__ */ jsx16("div", { className: "w-fit min-w-[27px]", children: /* @__PURE__ */ jsxs16(Text10, { size: "small", children: [
            ...
            /* @__PURE__ */ jsx16("div", { className: "flex items-center justify-end", children: /* @__PURE__ */ jsx16(Text10, { size: "small", className: "pt-[1px]", children: getLocaleAmount(item.subtotal || 0, currencyCode) }) })
          ] })
        ]
      },
      item.id
...
var Cost = ({
  ...
  secondaryValue,
  tooltip
}) => /* @__PURE__ */ jsxs16("div", { className: "grid grid-cols-3 items-center", children: [
  /* @__PURE__ */ jsxs16(Text10, { size: "small", leading: "compact", children: [
    label,
    " ",
    tooltip
  ] }),
  /* @__PURE__ */ jsx16("div", { className: "text-right", children: /* @__PURE__ */ jsx16(Text10, { size: "small", leading: "compact", children: secondaryValue }) }),
  /* @__PURE__ */ jsx16("div", { className: "text-right", children: /* @__PURE__ */ jsx16(Text10, { size: "small", leading: "compact", children: value }) })
] });
var CostBreakdown = ({
  order
}) => {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "text-ui-fg-subtle flex flex-col gap-y-2 px-6 py-4", children: [
    /* @__PURE__ */ jsx16(
      Cost,
      {
        label: t(
    ...
    isShippingOpen && /* @__PURE__ */ jsx16("div", { className: "flex flex-col gap-1 pl-5", children: (order.shipping_methods || []).sort(
      ...
      return /* @__PURE__ */ jsxs16(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx16("div", { children: /* @__PURE__ */ jsxs16("span", { className: "txt-small text-ui-fg-subtle font-medium", children: [
              sm.name,
    ...
    /* @__PURE__ */ jsxs16(Fragment3, { children: [
      /* @__PURE__ */ jsxs16("div", { className: "flex justify-between", children: [
        ...
        /* @__PURE__ */ jsx16("div", { className: "text-right", children: /* @__PURE__ */ jsx16(Text10, { size: "small", leading: "compact", children: getLocaleAmount(order.tax_total, order.currency_code) }) })
      ] }),
      ...
      return /* @__PURE__ */ jsxs16(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsx16("div", { children: /* @__PURE__ */ jsxs16("span", { className: "txt-small text-ui-fg-subtle font-medium", children: [
              i.inventory.title,
              i.inventory.sku && /* @__PURE__ */ jsxs16("span", { className: "text-ui-fg-subtle font-normal", children: [
                " ",
                "\u22C5 ",
                i.inventory.sku
              ] })
            ...
            /* @__PURE__ */ jsx16("div", { className: "relative flex-1", children: /* @__PURE__ */ jsx16("div", { className: "bottom-[calc(50% - 2px)] absolute h-[1px] w-full border-b border-dashed" }) }),
            /* @__PURE__ */ jsxs16("span", { className: "txt-small text-ui-fg-muted", children: [
              i.required_quantity,
              "x"
            ] })
          ]
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx16(Text10, { size: "small", children: t(`orders.returns.damagedItemsReturned`, {
        ...
        /* @__PURE__ */ jsxs16(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: [
...
var ReturnBreakdown = ({
  ...
  const item = orderReturn?.items?.find((ri) => ri.item_id === itemId);
  const damagedQuantity = item?.damaged_quantity || 0;
  return item && /* @__PURE__ */ jsxs16(Fragment3, { children: [
    ...
    /* @__PURE__ */ jsxs16(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsx16(ArrowDownRightMini, { className: "text-ui-fg-muted" }),
            /* @__PURE__ */ jsx16(Text10, { size: "small", children: t(
          ...
          orderReturn && isRequested && /* @__PURE__ */ jsxs16(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: [
...
var ClaimBreakdown = ({
  ...
  return !!items.length && /* @__PURE__ */ jsxs16(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx16(ArrowDownRightMini, { className: "text-ui-fg-muted" }),
          /* @__PURE__ */ jsx16(Text10, { size: "small", children: t(`orders.claims.outboundItemAdded`, {
        ...
        /* @__PURE__ */ jsx16(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: getRelativeDate(claim.created_at) })
      ]
    },
    claim.id
  );
  ...
  return !!items.length && /* @__PURE__ */ jsxs16(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs16("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx16(ArrowDownRightMini, { className: "text-ui-fg-muted" }),
          /* @__PURE__ */ jsx16(Text10, { size: "small", children: t(`orders.exchanges.outboundItemAdded`, {
            itemsCount: items.reduce(
              (acc, item) => acc = acc + item.quantity,
              0
            )
        ...
        /* @__PURE__ */ jsx16(Text10, { size: "small", leading: "compact", className: "text-ui-fg-muted", children: getRelativeDate(exchange.created_at) })
      ]
    },
    exchange.id
  );
...
var Total = ({ order }) => {
  const { t } = useTranslation15();
  return /* @__PURE__ */ jsxs16("div", { className: " flex flex-col gap-y-2 px-6 py-4", children: [
    /* @__PURE__ */ jsxs16("div", { className: "text-ui-fg-base flex items-center justify-between", children: [
      /* @__PURE__ */ jsx16(
        Text10,
        {
          weight: "plus",
...
var OrderDetail = () => {
  ...
  return /* @__PURE__ */ jsxs17(
    TwoColumnPage,
    {
      ...
      hasOutlet: true,
      children: [
        /* @__PURE__ */ jsxs17(TwoColumnPage.Main, { children: [
        ...
        /* @__PURE__ */ jsxs17(TwoColumnPage.Sidebar, { children: [
